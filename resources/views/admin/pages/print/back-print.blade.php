        ...
        <div class="nepali-card a4-size id-card page" style="height: 100vh; padding: 2px;">
            <div class="row">
                ...
                <div class="col-lg-12 fs-10">
                    <div class="row">
                        <div class="col-lg-6" style="width: 50%; font-size: 10px;">
                    ...
                    <div class="row">
                        <div class="col-lg-6" style="width: 100%; font-size: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6" style="width: 50%; font-size: 10px;">
                            <span>Citizenship No.: <span style="font-weight: 700">{{ convertNepaliToEnglish($applicant->citizenship_number) }}</span></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6" style="width: 50%; font-size: 10px;">
                            <span>Type of Disability: <span>{{ $applicant->disabilitySeverity->name_english }}</span></span>
                        </div>
                        <div class="col-lg-6" style="width: 50%; font-size: 10px;">
                            <span>Severity: <span>{{ $applicant->disability->severity_name_english }}</span></span><br>
                        </div>
                    </div>
                </div>
                <div class="row fs-10">
                    ...
                    <div class="col-lg-4" style="width: 33% !important">
                        <span style="font-size: 8px;">{{ $employee->name_english }}</span><br />
                    </div>
                    <div class="col-lg-2" style="width: 16% !important">
                        <img src="{{ $employee->getRedSignatureImage() }}" alt="red-signature" height="20px" /><br />
                    </div>
                    <div class="col-lg-3">
                        <span style="font-size: 8px;">{{ $employee->designation_english }}</span><br />
                    </div>
