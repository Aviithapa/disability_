                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input name="severity_name_nepali" class="form-control" id="basicInput" type="text" value="{{ old('severity_name_nepali') }}">
                                                 @if($errors->any())
                                                    <div style="color:red !important">
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input name="severity_name_english" class="form-control" id="basicInput"  value="{{ old('severity_name_english') }}" type="text">
                                                     @if($errors->any())
                                                    <div style="color:red !important">
