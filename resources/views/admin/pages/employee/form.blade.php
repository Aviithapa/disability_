                                    ...
                                    <form method="POST" action="{{ route('employee.store') }}">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label>Name</label>
                                                    <input name="name_english" class="form-control" id="basicInput" type="text" value="{{ old('name_english') }}">
                                                    @if($errors->any())
                                                        <div style="color:red !important">
                                                            {{ $errors->first('name_english') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label>Phone Number</label>
                                                    <input name="phone_number" class="form-control" id="basicInput" type="text" value="{{ old('phone_number') }}">
                                                    @if($errors->any())
                                                        <div style="color:red !important">
                                                            {{ $errors->first('phone_number') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <fieldset class="form-group">
                                                    <label>Designation</label>
                                                    <input name="designation" class="form-control" id="basicInput" type="text" value="{{ old('designation') }}">
                                                    @if($errors->any())
                                                        <div style="color:red !important">
                                                            {{ $errors->first('designation') }}
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group col-md-12 col-lg-12">
                                                                ...
                                                                <input type="file" id="red_signature_image" name="red_signature_image"
                                                                       onclick="anyFileUploader('red_signature')">
                                                                <input type="hidden" id="red_signature_path" name="red_signature" class="form-control"
                                                                       value="{{isset($data)?$data->red_signature:''}}"/>
                                                                @if($errors->any())
                                                                    <div style="color:red !important">
                                                                        {{ $errors->first('red_signature') }}
                                                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group col-md-12 col-lg-12">
                                                                ...
                                                                <input type="file" id="black_signature_image" name="black_signature_image"
                                                                       onclick="anyFileUploader('black_signature')">
                                                                <input type="hidden" id="black_signature_path" name="black_signature" class="form-control"
                                                                       value="{{isset($data)?$data->black_signature:''}}"/>
                                                                 @if($errors->any())
                                                                    <div style="color:red !important">
                                                                        {{ $errors->first('black_signature') }}
                                                                    </div>
